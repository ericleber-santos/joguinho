...
class GameActivity : AppCompatActivity() {
    ...
    private fun entrarModoImersivo() {
        // API 30+ (Android 11+): usa WindowInsetsController
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.R) {
            ...
            // API 19-29: usa flags tradicionais
        ...
        // Garante que o layout desenha atrás das barras do sistema
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Precisa postar pois o decorView pode não estar inicializado ainda
        window.decorView.post { entrarModoImersivo() }
